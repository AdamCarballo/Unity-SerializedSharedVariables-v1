...
namespace EngyneCreations.SSV.Editor {
	public static class SerializedSharedVariablesGenerator {
		...
		public static void GenerateNewVariableData(Type type) {
			...
			var scriptFile = Path.Combine(Application.dataPath, SerializedSharedVariables.GeneratedVariablesPath, $"{variableClass}.cs");
			...
			var relativePath = Path.Combine("Assets", SerializedSharedVariables.GeneratedVariablesPath, $"{variableClass}.cs");
		...
		public static void GenerateNewVariableEditor(Type type) {
			...
			// The generated filepath
			var scriptFile = Path.Combine(Application.dataPath, SerializedSharedVariables.GeneratedDrawersPath, $"{referenceDrawerClass}.cs");
			...
			var relativePath = Path.Combine("Assets", SerializedSharedVariables.GeneratedDrawersPath, $"{referenceDrawerClass}.cs");
			AssetDatabase.ImportAsset(relativePath);
		}
